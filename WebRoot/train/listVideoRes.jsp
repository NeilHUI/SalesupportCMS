  ...
  <head>
	...
	<script type="text/javascript">
		 ...
		 function forward2(param) 
		{
			 ...
			 {
				 location.href = "resPage!listRes?resPage.currentPage=" + param.value + "&resPage.onePageNum=" + pagesize+"&resource_type=1";
			 }
		}
			function search()
			{
				 ...
				 var pagesize = document.getElementById("pagesize").value;
				 location.href = "resPage!listRes?&resPage.onePageNum=" + pagesize+"&resource_type=1"+"&searchContent="+searchContent;
			//	 alert(searchContent);
			}
	</script>
  </head>
   ...
   <table class="table">
    	...
    	<tr>
    			...
    			<c:choose>
    				...
    				<c:otherwise>
    					<a href="resPage!listRes?resPage.currentPage=1&resPage.onePageNum=${resPage.onePageNum}&resource_type=1">首页</a>
    					<a href="resPage!listRes?resPage.currentPage=${resPage.currentPage-1 }&resPage.onePageNum=${resPage.onePageNum}&resource_type=1">上一页</a>
    				</c:otherwise>
    			</c:choose>
    			<c:choose>
    				...
    				<c:otherwise>
    					<a href="resPage!listRes?resPage.currentPage=${resPage.currentPage+1 }&resPage.onePageNum=${resPage.onePageNum}&resource_type=1">下一页</a>
    					<a href="resPage!listRes?resPage.currentPage=${resPage.totalPage }&resPage.onePageNum=${resPage.onePageNum}&resource_type=1">尾页</a>
    				</c:otherwise>
    			</c:choose>
