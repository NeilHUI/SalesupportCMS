  ...
  <div class="container"><!-- container-fluid靠左 -->
    ...
    <div class="collapse navbar-collapse" id="demo-navbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="training.jsp">培训课堂</a></li>
...
<div class="div_font"><span style="font-size: 30px">培训课堂</span> Training Class</div> 
<hr class="divider_1">
<br/>
<!-- 视频预留位置16:9 aspect ratio -->
<div class="embed-responsive embed-responsive-16by9" id="ratio_pos">
