...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="dashboard.jsp">维修人员管理</a> <div class="breadcrumb_divider"></div> <a class="current">添加维修人员</a></article>
		</div>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			...
			<div class="module_content">				
				<h4>请填写维修人员信息</h4> <input type='text' style="visibility:hidden" >
					<s:form action="personnel!addPersonnel.action" method="post" theme="simple">							
			    		<table>
			    		<tr>
			    			<td>姓名：</td>
			    			<td>
			    		...
			    		<tr>
			    			<td>年龄：</td>
			    			<td>
			    				<s:textfield name="myper.age"></s:textfield>
			    			</td>
			    		</tr>
			    		<tr>
			    			<td>性别：</td>
			    			<td>
			    				<s:radio list="{'男','女'}" name="myper.sex"></s:radio>
			    			</td>
			    		</tr>
			    		...
			    		<tr>
			    			<td>选择分组：</td>
			    			<td>
			    				<s:select list="{'第一组','第二组','第三组'}" name="myper.grade"></s:select>
			    			</td>
			    		</tr>
			    		<tr>
			    			<td>备注：</td>
